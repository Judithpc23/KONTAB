  ...
  return (
    <div className='  flex flex-col items-center justify-center bg-gradient-to-b from-[#F5F5F5] to-[#D0DDFF] bg-cover  min-w-[280px] min-h-screen p-5'>
      <main className="flex flex-col items-center justify-center w-full text-center">
        <div className='bg-[#FAFAFF] relative rounded-[3px] shadow-[0px_0px_70px_10px_rgba(0,0,0,0.1)] bg-cover bg-center w-[60%] min-w-[280px] flex md:w-[400px] lg:w-[1000px] xl:w-[1024px] h-[500px] md:h-[550px] lg:h-[600px] min-h-[450px] max-h-[1080px] max-w-[1700px]'>
