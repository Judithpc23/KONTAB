                        ...
                        <div className="carousel w-full mt-2 mb-10">
                            <div className="carousel-item w-full flex-col">
                                ...
                                <div className="flex justify-between mx-4 md:mx-10 lg:pb-5 lg:mx-[3rem]">
                                    <a href="#item1" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Atrás</a> 
                                    <a href="#item2" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Siguiente</a>
                                </div>
                            </div>
                            ...
                            <div className="carousel-item w-full flex-col">
                                ...
                                <div className="flex justify-between mx-4 md:mx-10 pb-5 lg:mx-[3rem]">
                                    <a href="#item1" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Atrás</a> 
                                    <a href="#item3" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Siguiente</a>
                                </div>
                            </div>
                            ...
                            <div className="carousel-item w-full flex-col">
                                ...
                                <div className="w-auto flex justify-between mx-4 md:mx-10 lg:mx-[3rem]">
                                    <a href="#item2" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Atrás</a> 
                                    <a href="#item3" className="text-[#7BA8FF] btn btn-neutral bg-transparent border-0 font-[nunito-sans-light] normal-case text-[11px] hover:bg-transparent hover:text-slate-400">Siguiente</a>
                                </div>
                            </div>
