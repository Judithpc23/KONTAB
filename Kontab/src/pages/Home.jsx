...
export const Home = () => {
    return (
        ...
        {/*
            <div className="navbar flex justify-end  2xl:h-[20%] xl:h-[5%] md:h-[5%] xl:w-[80%]  min-w-screen bg-[#ffff] border-b-[1px] border-[#A5C4FF]">
            ...
            */}
            ...
            <div className="hidden 2xl:w-[20%] xl:w-[17%] md:flex flex-col md:w-[15%] min-h-screen min-w-[180px] bg-[#7BA8FF] flex-start items-left direction-column text-white sm:w-[0%] sm:h-[0%]">

                <div id="Inicio" className=" text-[250%] p-2 flex justify-center">
                    <h1>Köntab</h1>
                </div>

                <div id="Usuario" className="p-5 flex justify-start items-center align-center border-b-[1px] border-t-[1px] border-[#A5C4FF] w-full">
                    ...
                    <div>
                        <p className="2xl:text-[150%] xl:text-[150%] md:text-[80%]">USUARIO</p>
                        <p className="2xl:text-[100%] xl:text-[100%] md:text-[40%]">Correo del usuario</p>
                    </div>

                </div>

                <div className="flex items-start -top- marginRight-[10%] marginLeft-[10%] justify-center">
                    <ul className="menu w-[95%] flex justify-center align-center 2xl:text-[190%] xl:text-[160%] md:text-[120%] sm:text-[100%] flex space-y-5">
                        <li id="Inicio">
                        ...
                        <li id="Salir">
                            <a className="hover:bg-white hover:bg-opacity-20 hover:text-white h-[50px] flex align-center mt-[0px] pt-[0px">
            ...
            <div className="md:flex md:items-end md:w-full h-[58px] w-[83%] bg-[#ffff] border-b-[1px] border-[#A5C4FF]">
            {NavbarDefault()}
            </div>
