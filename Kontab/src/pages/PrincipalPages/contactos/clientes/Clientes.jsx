...
export const Clientes = ({usuarioKontab}) => {
    return(
        <div className="">
            <div className="flex justify-between items-center h-[100px] bg-white p-5 rounded-t-lg">
                ...
                <Button onClick={()=>document.getElementById('modalAddClient').showModal()} className="btn flex justify-center items-center text-[#FFF] font-medium bg-[#3f4fff] border-none hover:bg-[#5f3fff]">AGREGAR CLIENTE</Button>
            ...
            <div className="h-[45vh] overflow-y-auto min-h-[400px]">
                <table   className="table-auto w-full bg-white rounded-b-lg">
                    ...
                    <tbody>
                        ...
                        {
                            usuarioKontab.contactos.clientes.map((value,index) => {
                                return(
